...
- 🏢 I'm currently also an NSF Fellow & Quantum Hardware Engineer at IBM Research, Yorktown Heights ([TJ Watson Research Center](https://en.wikipedia.org/wiki/Thomas_J._Watson_Research_Center)). Here, I advance the scaling/ accuracy of qubits using cryogenic classical memory chips for qubit control/ readout data.
